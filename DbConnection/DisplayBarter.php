...
// $content = $Decode_React_APP_Data['All_cont'];


$query = 'SELECT b.barter_name,b.barter_item_id,b.description,b.dateCreated,b.status,b.user_id, CONCAT(u.firstname," ",u.lastname) as fullname,u.image_link as profpic, pic.image_link, pic.images FROM student_users u, barter_items b LEFT JOIN barter_items_pics pic ON pic.image_link = b.image_link WHERE b.status = "Available" AND b.user_id = u.user_id';
